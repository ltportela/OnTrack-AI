---
description: "Skill for managing student psychometric profiling metrics under the IDSRAL protocol, including MSLQ motivation spectrum and Schaufeli academic burnout index.\n"
metadata: {"spec_reference":".agents-cli-spec.md"}
---
